...
Deploys basic contracts to Ganache using the first account
"""
...
def deploy_simple_contracts():
    """Deploy simple contracts to Ganache"""
    ...
    try:
        ...
        # Sign transaction (using the first account's private key)
        # For Ganache, we can use the default private key
        ...
        signed_tx2 = w3.eth.account.sign_transaction(constructor_tx2, private_key)
